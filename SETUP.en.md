...
- Create all necessary tables (users, services, bookings, contacts)
...
- **Contacts:** `http://localhost:3000/contacts.html`
...
3. **Frontend is accessible:** Open `http://localhost:3000/index.html` in browser
