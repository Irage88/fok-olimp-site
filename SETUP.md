...
- **Личный кабинет:** `http://localhost:3000/dashboard.html`
- **Услуги:** `http://localhost:3000/services.html`
...
3. **Frontend доступен:** Откройте `http://localhost:3000/index.html` в браузере
